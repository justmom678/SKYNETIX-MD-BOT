...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || 'SKYNETIX-MD',
    botOwner: process.env.BOT_OWNER || 'skynetix md',
    ownerNumber: (process.env.OWNER_NUMBER || '+263776695904').replace(/\D/g, ''),
    author: process.env.AUTHOR || 'Skynetix',
    developer: process.env.DEVELOPER || 'Skynetix',
    packname: process.env.PACKNAME || 'SKYNETIX-MD',
