...
const phoneNumber = config.pairingNumber || config.ownerNumber || "263776695904";
...
global.botname = config.botName || "SKYNETIX-MD";
global.themeemoji = "•";
    ...
    try {
        ...
        if (pairingCode && !isRegistered) {
            ...
            if (config.pairingNumber) {
                ...
                phoneNumberInput = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: 263776695904 (without + or spaces) : `)));
            }
            else {
        ...
        QasimDev.ev.on('connection.update', async (s) => {
            ...
            if (connection === "open") {
                ...
                printLog('info', `[ ${config.botName || 'SKYNETIX-MD'} ]`);
...
async function main() {
    ...
    printLog('info', 'Starting Skynetix MD BOT...');
