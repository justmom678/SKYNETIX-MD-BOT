...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId) {
  ...
  "sisterfucker",
  "sister's cunt",
  "merchant of testicles",
  "mosquito's pubic hair",
  "pubic hair",
  "whore",
  "breasts",
  "your mother's cunt",
  "your mother's",
  "pubic hair on the penis",
  "dickhead",
  "get your ass fucked",
  "dick hair",
  "shortened form of motherfucker",
  "sister's dick",
  "fucking",
  "damn dog",
  "bastard",
  ...
  // Obfuscated or abbreviated forms
  "fuck",
  "fucker",
  "bitch",
  "fuck",
  ...
  "ass",
  "dickhead",
  "dick with a sexual-number reference",

  // Ethnic, racial, or religious slurs
  "anti-Latin American slur",
  "anti-East Asian slur",
  "anti-white American slur",
  "anti-Arab or anti-Muslim slur",
  "anti-East Asian slur",
  "anti-Jewish slur",
  "anti-South Asian slur",
  "anti-white slur",
  "anti-Latino slur",
  "anti-Arab or anti-Muslim slur",
  "anti-Black slur",
  ...
  "middle-aged woman considered sexually attractive",
  "anal sex",
  "sexual climax",
  "sex toy",
  "sex toy",
  "group sex",
  "sex involving three people",
  "pornography",
  "sexual activity",
  "adult-content abbreviation",

  // Sexuality and gender-related insults
  "homophobic slur",
  "homophobic slur",
  "lesbian-related slur",
  "transgender-related slur",
  "homosexual",
  "effeminate person",
  "effeminate person",
  "lesbian-related slur",

  // Drugs and drug-related terms
  "cannabis",
  "cannabis",
  "cocaine",
  "heroin",
  ...
  "hashish",
  "drug trip",
  "rolling papers or rolling a joint"
    ];
