#!/bin/bash
# SKYNETIX -MD Fly.io One-Click Deployer
# Usage: bash <(curl -s https://raw.githubusercontent.com/justmom678/SKYNETIX -MD/main/lib/fly.sh)
...
echo -e "${CYAN}"
echo "╔═══════════════════════════════════════╗"
echo "║        SKYNETIX -MD Fly.io Deployer        ║"
echo "║          by justmom678           ║"
echo "╚═══════════════════════════════════════╝"
echo -e "${NC}"
...
read -p "$(echo -e ${CYAN}Session ID (Skynetix/SKYNETIX-MD_xxxxx): ${NC})" SESSION_ID
