...
async function handleMessages(sock, messageUpdate) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '*Join our Channel:*\n[https://whatsapp.com/channel/0029VaxJHLb5a248k7Cz8F0a](https://whatsapp.com/channel/0029VaxJHLb5a248k7Cz8F0a)'
                }, { quoted: message });
                return;
            }
                ...
                await sock.sendMessage(chatId, {
                    text: `*Support*\nhttps://whatsapp.com/channel/0029VaxJHLb5a248k7Cz8F0a`
                }, { quoted: message });
                return;
            }
        }
