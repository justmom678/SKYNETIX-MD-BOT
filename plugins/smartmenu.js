...
export default {
    ...
    async handler(sock, message, args, context) {
        ...
        try {
            ...
            let menuText = `${menuEmoji} *${config.botName || 'SKYNETIX-MD'}* ${menuEmoji}\n\n`;
            menuText += `┏━━━━━━━━━━━━━━━━┓\n`;
            menuText += `┃ 📱 *Bot:* ${config.botName || 'SKYNETIX-MD'}\n`;
            ...
            menuText += `\n🔊 *Voice menu:* ${config.voiceMenuUrl}`;
            const contextInfo = {
                forwardingScore: 1,
                isForwarded: true,
            ...
            await sock.sendMessage(chatId, { audio: fs.readFileSync(path.join(process.cwd(), 'assets/voice-menu.mp3')), mimetype: 'audio/mpeg', ptt: true }, { quoted: message });
        }
        catch (error) {
